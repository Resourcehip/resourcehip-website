---
title: "What is the Regenerative Index? Why HIP Has a Dimension That Goes Negative"
slug: what-is-the-regenerative-index
category: methodology
description: "The Regenerative Index is the only HIP dimension with a negative scale — from -10 to +10. Here is why it exists, what each of the five tiers means, and why almost every consumer product today is Depleting."
keywords: [Regenerative Index, RI, regenerative consumer products, depleting vs regenerative, sustainability tiers, HIP score]
...
The RI is one of the seven dimensions of the [HIP Score](/blog/what-is-the-hip-score), with a 15% weight in the final figure. The reference page at [`/methodology`](/methodology) has the full rubric.
...
- The [HIP Score explainer](/blog/what-is-the-hip-score) for how the seven dimensions combine.
- The [generic-vs-verified explainer](/blog/generic-vs-verified-ratings) for how a manufacturer can move a category-default rating into a verified one.
- The [methodology reference page](/methodology) for the full rubric and worked examples.
- The [ratings catalogue](/ratings) — every rating shows both the RI raw value and the band name.

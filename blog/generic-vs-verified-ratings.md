---
title: "Generic vs Verified Ratings: Why the Gap Exists, and What Closes It"
slug: generic-vs-verified-ratings
category: methodology
description: "Every Resourcehip rating is one of two types. Generic ratings rate the category. Verified ratings rate a specific evidenced product. The gap between them is the headroom — the space where a manufacturer can demonstrably outperform the assumed default."
keywords: [generic vs verified ratings, HIP score baseline ceiling, manufacturer rating submission, conservative defaults]
...
- **Verified ratings** are produced from data submitted by the manufacturer through the [submission form](/submit). Submitted data replaces the conservative defaults. They rate a **specific evidenced product** at a specific point in time.
...
The [submission form](/submit) is the formal route. The data we ask for falls into seven groups, one per HIP dimension — material composition, recycled content, supply countries and audits, repair documentation, environmental certifications, warranty and design life, and end-of-life recovery evidence.
...
- The [HIP Score explainer](/blog/what-is-the-hip-score) for how the seven dimensions combine into a single number.
- The [Regenerative Index explainer](/blog/what-is-the-regenerative-index) for the dimension where negative scores are valid.
- The [methodology reference page](/methodology) for the full rubric and worked examples.
- The [submission form](/submit) — for manufacturers ready to move from a generic rating to a verified one.

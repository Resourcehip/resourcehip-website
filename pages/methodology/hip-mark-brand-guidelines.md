---
title: HIP Mark Brand Guidelines
page_description: Visual standards and licensing requirements for manufacturers displaying the HIP Mark on products and packaging.
...
The brand olive used elsewhere in Resourcehip materials is `#6B8E23`. It is not a tier colour and must not be substituted for one.
...
*HIP Mark and HIP Score are trade marks of Resourcehip Ltd. The HIP Score methodology is published under [Creative Commons CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/). The HIP Mark is proprietary and may not be used without a current licence.*

*Resourcehip Ltd · Office 90, Alloa Business Centre, Whins Road, Alloa, FK10 3SA · Company number SC873386 · hello@resourcehip.com*

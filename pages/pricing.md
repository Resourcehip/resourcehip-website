---
title: "Pricing"
page_description: "Schedule of fees for Resourcehip HIP Rating assessments and certification. Independent material resilience assessments for manufacturers — Generic Ratings, Verified Ratings, and annual subscription plans."
active_page: pricing
---
...
- **Independent verification** — a scored, evidence-based assessment by a third party, not a self-declaration. Assessors review material composition, supply-chain provenance, repairability, and end-of-life documentation.
- **ESG and procurement credibility** — a published rating on resourcehip.com provides a citable, stable reference for ESG reporting, procurement tender responses, and retailer onboarding requirements.
- **Risk reduction** — the HIP methodology applies conservative defaults wherever evidence is absent. Commissioning a Verified Rating replaces those defaults with your actual product data, producing a score that reflects genuine performance.
...
- Full assessment against all seven HIP dimensions
- A published rating page on resourcehip.com, tied to your brand and product
- Written rationale for each dimension score, including evidence used
- Category peer comparison against the published conservative baseline
...
If you expect to commission fewer than four ratings in the next year, pay-per-rating is simpler. If you have a product portfolio to benchmark over time, or expect four or more ratings, the Annual Base plan bundles four Verified Ratings at a lower per-rating cost. The Annual Premium plan is for larger portfolios — six Verified Ratings and a deeper discount on additional ratings.
...
You may dispute a rating at any time at no cost. The process is described on our [Dispute](/dispute) page. If new evidence materially changes a dimension score, we update the published rating and note the revision date and reason.
